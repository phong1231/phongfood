...
<style>
    .container {
        ...
        height: 100vh;
        /* Chiều cao của container là 100% chiều cao của viewport */
    }

    .row {
        width: 100%;
        /* Đảm bảo hàng nằm trên toàn bộ chiều rộng của container */
    }
    ...
    <div class="container col-6  ">
        <div class=" row ">
            <div class="card   " style=" width: 600px;">
                <h3 class="text-center  card-header">Thêm Sp</h3>
                <form method="POST" action="index.php?action=addsanpham" enctype="multipart/form-data" >
                    <table class="table" style="border: 0px;  ">
                        ...
                        <tr>
                            <td>Hình</td>
                            <td><input type="file" class="form-control" name="hinh" value="<?php if (isset ($hinh))
                                echo $hinh; ?>" maxlength="100px"></td>
                        </tr>
                        <tr>
                            <td>Mã loại</td>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control"
                                    value="<?php if (isset ($soluongton))
                                        echo $soluongton; ?>" name="soluongton">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-center">
                            <input class="btn btn-warning form-control" type="submit" name="submit" value="Lưu">
                            </td>
                        </tr>
                    </table>
                </form>
